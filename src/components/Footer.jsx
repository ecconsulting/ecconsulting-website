...
export default function Footer() {
  ...
  return (
    <footer className="bg-ink text-white">
      ...
      <div className="container-shell grid gap-10 py-16 md:grid-cols-[minmax(13rem,0.72fr)_minmax(20rem,1.28fr)] md:items-start lg:gap-14">
        <div className="grid gap-8 md:max-w-xs">
          <div>
          ...
          <nav aria-label="Footer navigation" className="border-t border-white/10 pt-6">
        ...
        <div className="md:flex md:justify-end">
          <ContactBlock compact singleColumn className="w-full md:max-w-xl" />
        </div>
      </div>
